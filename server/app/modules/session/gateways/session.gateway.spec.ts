...
import { ChatGateway } from '@app/gateways/session/session.gateway';
...
import { ChatEvents } from './session.gateway.events';
import { DELAY_BEFORE_EMITTING_TIME, PRIVATE_ROOM_ID } from './session.gateway.constants';
